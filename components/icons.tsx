...
export const UniversityIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 3L1 9l11 6 9-4.91V17h2V9L12 3zm-1 9.07V9.93l-6-3.27 6 3.41zM12 13.33L4.23 9 12 4.67 19.77 9 12 13.33z"/>
    <path d="M5 13.18V17.5l7 3.5 7-3.5V13.18l-7 3.5-7-3.5z"/>
  </svg>
);
...
export const WebDevIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
);
export const WebDesignIcon: React.FC<IconProps> = (props) => (
...
export const MobileDevIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
);
export const NotaryIcon: React.FC<IconProps> = (props) => (
...
export const BalanceIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l-2.62 10.726c-.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.036.243c-2.132 0-4.14-.818-5.62-2.24l-2.62-2.138a5.988 5.988 0 01-1.28-5.717L12 4.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 4.97A48.416 48.416 0 0112 4.5c2.291 0 4.545.16 6.75.47m-13.5 0c-1.01.143-2.01.317-3 .52m3-.52l-2.62 10.726c-.122.499.106 1.028.589 1.202a5.988 5.988 0 002.036.243c2.132 0 4.14-.818 5.62-2.24l2.62-2.138a5.988 5.988 0 001.28-5.717L12 4.5" />
    </svg>
);

export const PaletteIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" {...props}>
    <path d="M17.151 2.32244C15.691 0.862441 13.241 -0.017559 10.701 2.51244C8.69101 4.52244 8.79101 7.64244 10.531 9.38244C12.271 11.1224 15.391 11.2224 17.401 9.21244C19.931 6.67244 18.611 3.78244 17.151 2.32244Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    <path d="M12.95 18.05C10.75 20.25 7.6 21.25 4.5 20.5C2.5 20 1.5 19 2 17C2.5 15 3.5 14 5.5 13.5C8.6 12.75 11.75 13.75 13.95 15.95C14.7176 16.7176 15.2824 17.2824 16.05 18.05C15.2824 18.8176 13.7176 18.8176 12.95 18.05Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
