  ...
  return (
    <section id="skills" className="py-20 md:py-32">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 font-grotesk reveal" style={{ transitionDelay: '0.1s' }}>
          Skills & <span className="text-vermilion">Tools</span>
        </h2>
        <p className="text-light-gray mb-12 max-w-2xl mx-auto reveal" style={{ transitionDelay: '0.2s' }}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {skillsData.map((skill, index) => (
            <div 
              key={skill.name} 
              className="glass-card p-6 rounded-xl flex flex-col items-center justify-center group transition-all duration-300 hover:border-vermilion hover:shadow-glow transform hover:-translate-y-2 reveal min-h-[120px]"
