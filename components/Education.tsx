  ...
  return (
    <section id="education" className="py-20 md:py-32 bg-dark-card">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-12 font-grotesk reveal">Education</h2>
        <div className="max-w-3xl mx-auto glass-card p-8 rounded-xl shadow-lg border border-border-gray reveal">
